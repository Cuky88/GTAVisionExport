...
if __name__ == '__main__':
    ...
    if  args.mask is not None:
        ...
        for img in data:
            ...
            cv2.imshow(img["Image"].split(".")[0] + depth_s, ffim)
            key = cv2.waitKey(0)
            cv2.destroyAllWindows()
